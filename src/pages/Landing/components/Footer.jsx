...
export default function Footer() {
  return (
    <div>
       <div className='bg-[#d6cab5] mx-auto max-w-screen py-2 md:py-4 px-2 lg:px-2 lg:py-0  mt-6'>
  
  <footer className="p-4 bg-inherit rounded-3xl sm:p-6 dark:bg-[#d6cab5]">
<div className="md:flex md:justify-between">
  ...
  <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
      <div>
          <h2 className="mb-6 text-sm font-semibold uppercase text-emerald-900">Resources</h2>
          <ul className="text-emerald-900 dark:text-emerald-900">
              <li className="mb-4">
                  <a href="/investor" className="hover:underline">Investor Portal</a>
              </li>
              <li>
                  <a href="/lands" className="hover:underline">SokoLands</a>
              </li>
          </ul>
      </div>
      <div>
          <h2 className="mb-6 text-sm font-semibold text-emerald-900 uppercase dark:text-emerald-900">Follow us</h2>
          <ul className="text-emerald-900 dark:text-emerald-900">
              <li className="mb-4">
                  <a href="https://github.com/sirgama/sokohub" className="hover:underline ">Twitter</a>
              </li>
              <li>
                  <a href="https://linkedin.com/company/sokohub" className="hover:underline">Linkedin</a>
              </li>
          </ul>
      </div>
      <div>
          <h2 className="mb-6 text-sm font-semibold text-emerald-900 uppercase dark:text-emerald-900">Legal</h2>
          <ul className="text-emerald-900 dark:text-emerald-900">
              <li className="mb-4">
...
<div className="sm:flex sm:items-center sm:justify-between">
  <span className="text-sm text-emerald-900 sm:text-center dark:text-emerald-900">© 2022 <a href="#" className="hover:underline">SokoHub™</a>. All Rights Reserved.
  </span>
  <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
      <a href="#" className="text-emerald-900 hover:text-gray-900 dark:hover:text-white">
