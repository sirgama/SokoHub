...
<div class="w-full flex flex-wrap">
      ...
      <span className="self-center text-2xl font-medium font-sans whitespace-nowrap dark:text-green-800">SokoHub</span>
        ...
        <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <form class="flex flex-col pt-3 md:pt-8" onSubmit="event.preventDefault();">
                ...
                <input type="submit" value="Log In" class="bg-green-800 text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8" />
            </form>
            <div class="text-center pt-12 pb-12">
                <p>Don't have an account? <Link to="/auth/signup" class="underline font-semibold">Register here.</Link></p>
            </div>
        </div>
    ...
    <div class="w-1/2 shadow-2xl">
        <img class="object-cover w-full h-screen hidden md:block" src="https://images.pexels.com/photos/2252584/pexels-photo-2252584.jpeg?auto=compress&cs=tinysrgb&w=1600" />
    </div>
</div>
